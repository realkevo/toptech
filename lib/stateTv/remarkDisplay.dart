...
class RemarkDisplayClass extends StatefulWidget {
  @override
  _RemarkDisplayClassState createState() =>
      _RemarkDisplayClassState();
}
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream:
                FirebaseFirestore.instance.collection('remarkData').snapshots(), 
            builder: (context, snapshot) {
              if (!snapshot.hasData ||
              ...
              List<DocumentSnapshot> duplicatedRemarks = [
                ..._remarks,
                ..._remarks
              ];
              ...
              return Listener(
                ...
                child: SingleChildScrollView(
                    ...
                    child: Row(
                      children:
                          duplicatedRemarks.map((currentRemark) {
                        var name = currentRemark['remarkName'];
                        var description = currentRemark['remarkDescription'];
